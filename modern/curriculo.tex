...
\renewcommand*{\namefont}{\fontsize{23}{29}\mdseries\upshape}
...
\hypersetup{
  ...
  linkcolor=burgundy,         % color of internal links
  citecolor=green,        % color of links to bibliography
  filecolor=magenta,      % color of file links
  urlcolor=burgundy          % color of external links
}

\urlstyle{same}
% personal data
\name{Eduardo}{M. R. Oliveira}
...
\begin{minipage}[t]{.87\linewidth}
  \makecvtitle
\end{minipage}
\begin{minipage}[c]{.13\linewidth} % set percentage of line width as desired
  \includegraphics[width=64pt]{oui.png} %set scale as desired, picture named profile.png
\end{minipage}
\input{education}
\input{professional}
\input{web}
