...
\AfterPreamble{
	\hypersetup{
	  ...
	  pdfproducer={XeTex},    % producer of the document
...
\newcommand{\seii}{Software Engineer II}
\newcommand{\sse}{Senior Software Engineer}
...
\newcommand{\linktoemail}[1]{\href{mailto:#1}{\scriptsize\faEnvelope}}
